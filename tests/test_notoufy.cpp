...
public:
  virtual void onEvent() override { notified = true; }

  virtual void onEventIncrement() override { ++counter; }

  virtual void onEvent1([[maybe_unused]] int arg) override { notified = true; }

  bool called() const { return notified; }

  const uint32_t &count() const { return counter; }
